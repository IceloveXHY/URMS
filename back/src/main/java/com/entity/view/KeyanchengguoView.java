...
public class KeyanchengguoView extends KeyanchengguoEntity implements Serializable {
	...
	* 成果类别的值
	*/
	@ColumnInfo(comment="成果类别的字典表值",type="varchar(200)")
	private String keyanchengguoValue;
	/**
	* 成果类型的值
	*/
	@ColumnInfo(comment="成果类型的字典表值",type="varchar(200)")
	private String keyanchengguoLeixingValue;
	/**
	* 申请状态的值
	*/
	@ColumnInfo(comment="申请状态的字典表值",type="varchar(200)")
	private String keyanchengguoYesnoValue;
	...
	* 获取： 成果类型的值
	*/
	public String getKeyanchengguoLeixingValue() {
		return keyanchengguoLeixingValue;
	}
	/**
	* 设置： 成果类型的值
	*/
	public void setKeyanchengguoLeixingValue(String keyanchengguoLeixingValue) {
		this.keyanchengguoLeixingValue = keyanchengguoLeixingValue;
	}
	//当前表的
	/**
	* 获取： 申请状态的值
	*/
	public String getKeyanchengguoYesnoValue() {
		return keyanchengguoYesnoValue;
	}
	/**
	* 设置： 申请状态的值
	*/
	public void setKeyanchengguoYesnoValue(String keyanchengguoYesnoValue) {
		this.keyanchengguoYesnoValue = keyanchengguoYesnoValue;
	}
	...
	public String toString() {
		return "KeyanchengguoView{" +
			", xuekeValue=" + xuekeValue +
			", keyanchengguoValue=" + keyanchengguoValue +
			", keyanchengguoLeixingValue=" + keyanchengguoLeixingValue +
			", keyanchengguoYesnoValue=" + keyanchengguoYesnoValue +
