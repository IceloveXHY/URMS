    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表 学院部门
            //级联表
            XueyuanbumenEntity xueyuanbumen = xueyuanbumenService.selectById(yonghu.getXueyuanbumenId());
    ...
    */
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuEntity==null){
            ...
            return R.error(511,"账户或者科研人员手机号或者科研人员身份证号已经被使用");
        }
    }
...
//                            yonghuEntity.setXueyuanbumenId(Integer.valueOf(data.get(0)));   //学院部门 要改的
//                            yonghuEntity.setYonghuUuidNumber(data.get(0));                    //科研人员编号 要改的
//                            yonghuEntity.setYonghuName(data.get(0));                    //科研人员姓名 要改的
//                            yonghuEntity.setYonghuPhone(data.get(0));                    //科研人员手机号 要改的
//                            yonghuEntity.setYonghuIdNumber(data.get(0));                    //科研人员身份证号 要改的
...
//                            yonghuEntity.setZhiwuTypes(Integer.valueOf(data.get(0)));   //职务 要改的
//                            yonghuEntity.setZhichengTypes(Integer.valueOf(data.get(0)));   //职称 要改的
...
//                            yonghuEntity.setCreateTime(date);//时间
                        ...
                        if(yonghuEntities_yonghuUuidNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [科研人员编号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //科研人员手机号
                        ...
                        if(yonghuEntities_yonghuPhone.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [科研人员手机号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
                         //科研人员身份证号
                        ...
                        if(yonghuEntities_yonghuIdNumber.size() >0 ){
                            ...
                            return R.error(511,"数据库的该表中的 [科研人员身份证号] 字段已经存在 存在数据为:"+repeatFields.toString());
                        }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", "科研人员");
        R r = R.ok();
        r.put("token", token);
        r.put("role","科研人员");
...
//    	ValidatorUtils.validateEntity(user);
        ...
        YonghuEntity yonghuEntity = yonghuService.selectOne(queryWrapper);
        if(yonghuEntity != null)
            return R.error("账户或者科研人员手机号或者科研人员身份证号已经被使用");
    ...
    public R getCurrYonghu(HttpServletRequest request){
        ...
        if(yonghu !=null){
            ...
            //级联表
                            XueyuanbumenEntity xueyuanbumen = xueyuanbumenService.selectById(yonghu.getXueyuanbumenId());
            if(xueyuanbumen != null){
                BeanUtils.copyProperties( xueyuanbumen , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                view.setXueyuanbumenId(xueyuanbumen.getId());
            }
            //修改对应字典表字段
            dictionaryService.dictionaryConvert(view, request);
